...
if (isset($_GET['scr'])){
    ...
    elseif($scr=="Buscar"){
            ...
            if($filtroBus=='desc'){
            $consulta="SELECT `id_articulo`,`cod_bar_prov`, `cod_bar`, `desc_larga`, `costo`, `precio1`, `precio2`, `fec_act` FROM articulo 
...
if($proveedor > 0){
$sql = "SELECT `id_articulo`,`cod_bar_prov`, `cod_bar`, `desc_larga`, `costo`, `precio1`, `precio2`, `fec_act`
        FROM articulo 
        WHERE estado = '1' AND 
  ...
  <table width="1200" border="1" align="center" >
    ...
    <tbody>
      ...
      if ($result->num_rows > 0) {
        ...
        echo "<td>$" . number_format($row['precio2'], 2)."</td>";
