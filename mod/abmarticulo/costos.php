...
<form action="abmArticulo.php?scr=costosmodif" method="post" name="form1" id="form1" autocomplete="on" title="form1">
		  ...
		  <tbody>
			<tr>
			  <th height="133"><table width="800" border="0" align="center">
			    <tbody>
			      ...
			      <tr>
			        <td width="101" align="left" bgcolor="#A1A1A1">Cod. Ref.:</td>
			        <td width="322" align="left" bgcolor="#A1A1A1">
			...
			<tr>
			  <td><table width="800" border="0" align="center">
			    <tbody>
			      <tr>
			        <th colspan="3">Composición de Costos</th>
		          </tr>
			      <tr>
			        <td>Costo sin I.V.A. : 
			      ...
			      <tr>
			        <td align="center" bgcolor="#A1A1A1">(Costo+(Bonif+Flete+Carg. Finan))+(Iva+Imp. Int)</td>
			      ...
			      <tr>
			        <td align="center" bgcolor="#A1A1A1"><input name="costo_neto" type="text" readonly id="costo_neto">
		            Costo Final </td>
			...
			<tr>
			  <td><table width="700" border="0" align="center">
			    <tbody>
			      <tr>
			        <th colspan="4" scope="col">Precio de Venta</th>
		          </tr>
			      <tr>
			        <td width="64" height="21">&nbsp;</td>
			        <td width="168" align="center">Aumento en Porc.</td>
			        <td width="203" align="center">Importe de Aumento</td>
			        <td width="247" align="center">Precio de Venta </td>
		          </tr>
			      <tr>
			        ...
			        <td height="21" align="center">$<input type="number" step="any" name="PV1" id="PV1" tabindex="6"  style="width:140px;" onBlur="ponerCeroSiVacio(this,4), calcular2()" value="<?PHP echo $VAL16; ?>"></td>
		          </tr>
			      <tr>
			        ...
			        <td height="21" align="center">$<input type="number" name="PV2" id="PV2" tabindex="8" style="width:140px;" onBlur="ponerCeroSiVacio(this,4), calcular2()"  value="<?PHP echo $VAL17; ?>"></td>
		          </tr>
			      <tr>
			        ...
			        <td height="21" align="center">$<input type="number" name="PV3" id="PV3" tabindex="10" style="width:140px;" onBlur="ponerCeroSiVacio(this,4), calcular2()"  value="<?PHP echo $VAL18; ?>"></td>
		          </tr>
			      <tr>
			        ...
			        <td height="21" align="center">$<input type="number" name="PV4" id="PV4" tabindex="12" style="width:140px;" onBlur="ponerCeroSiVacio(this,4), calcular2()"  value="<?PHP echo $VAL19; ?>"></td>
		          </tr>
			      <tr>
			        <td height="26" colspan="4" align="center">&nbsp;</td>
		          </tr>
			      <tr>
			        <td height="26" colspan="4" align="center"><a href="abmArticulo.php" class="btn btn-outline-secondary">Cancela</a> - 
    ...
    function calcular(){
		...
		//CALCULAMOS IVA MAS IMPUESTOS 
		var iva_imp_int = ((iva + imp_int)/100)+1 ; 
		
        //CALCULAR COSTO 
		var costoneto = (costo - imp_bonif + imp_flete + imp_cfin) * iva_imp_int ;
		
		//TRANSFORMAMOS EN VALORES NUMERICO CON 4 DECIMALES
		costoneto=(parseFloat(costoneto).toFixed(4)).toString().split(". ");
		
		//COLOCAMOS LOS VALORES
		document.getElementById("costo_neto").value = costoneto;
		...
		var PVF1 = (costoneto * ((PorcVta1 / 100)+ 1));
		PVF1=Number((parseFloat(PVF1).toFixed(4)).toString().split(". "));	
       ...
       //CALCULAMOS EL PRECIO DE VENTA 2
		...
		var PVF2 = (costoneto * ((PorcVta2 / 100)+ 1));
		PVF2=Number((parseFloat(PVF2).toFixed(4)).toString().split(". "));	
		document.getElementById("PV2").value = PVF2 ;
        }
        //CALCULAMOS EL PRECIO DE VENTA 3
        if (PorcVta1 <= 1) {
        document.getElementById("PV3").value = costoneto;
        } else  {
		var PVF3 = (costoneto * ((PorcVta3 / 100)+ 1));
		PVF3=Number((parseFloat(PVF3).toFixed(4)).toString().split(". "));	
		...
		var PVF4 = (costoneto * ((PorcVta4 / 100)+ 1));
		PVF4=Number((parseFloat(PVF4).toFixed(4)).toString().split(". "));	
        ...
        var ImporAumento1 = PVF1 - costoneto; 
        ImporAumento1=Number((parseFloat(ImporAumento1).toFixed(4)).toString().split(". "));  
        document.getElementById("IA1").value = ImporAumento1;
		
        var ImporAumento2 = PVF2 - costoneto; 
        ImporAumento2=Number((parseFloat(ImporAumento2).toFixed(4)).toString().split(". "));  
        document.getElementById("IA2").value = ImporAumento2;

        var ImporAumento3 = PVF3 - costoneto; 
        ImporAumento3=Number((parseFloat(ImporAumento3).toFixed(4)).toString().split(". "));  
        document.getElementById("IA3").value = ImporAumento3;

        var ImporAumento4 = PVF4 - costoneto; 
        ImporAumento4=Number((parseFloat(ImporAumento4).toFixed(4)).toString().split(". "));  
    ...
    function calcular2(){
		...
		var costo = Number(document.getElementById('costo_neto').value); //COSTO
        ...
        var ImporAumento1 = PreVta1 - costo; 
        ImporAumento1=Number((parseFloat(ImporAumento1).toFixed(6)).toString().split(". "));  
        document.getElementById("IA1").value = ImporAumento1;
		
        var ImporAumento2 = PreVta2 - costo; 
        ImporAumento2=Number((parseFloat(ImporAumento2).toFixed(6)).toString().split(". "));  
        document.getElementById("IA2").value = ImporAumento2;

        var ImporAumento3 = PreVta3 - costo; 
        ImporAumento3=Number((parseFloat(ImporAumento3).toFixed(6)).toString().split(". "));  
        document.getElementById("IA3").value = ImporAumento3;

        var ImporAumento4 = PreVta4 - costo; 
        ImporAumento4=Number((parseFloat(ImporAumento4).toFixed(6)).toString().split(". "));  
        document.getElementById("IA4").value = ImporAumento4;
