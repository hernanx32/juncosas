...
function menu($nro_cat, $nom_completo, $nomb_acc)
{
...
<!-- Navbar -->
  <nav class="navbar-expand-md navbar-light navbar" >
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse order-3" id="navbarCollapse">
        ...
        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
			...
			<li><a href="mod/login/salir.php" class="dropdown-item">Salir</a></li>
		</ul>
		</li><!-- Fin Menu1  -->
		<!-- Inicio Menu2 -->	
		...
		<a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle">Precios</a>
			<ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
              ...
              <li><a href="ActivaArticulo.php" class="dropdown-item">Habilitar Articulo</a></li>
			</ul>
		</li><!-- Fin Menu2  -->
        <!-- Inicio Menu3 -->	
		<li class="nav-item dropdown"><!-- Menu2  -->
		<a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle">Stock</a>
			<ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                <li><a href="abmRem_ing_prov.php" class="dropdown-item">Remitos Proveedores</a></li>
		...
		<a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle">Configuraciones</a>
            ...
            <li><a href="iva.php" class="dropdown-item">IVA</a></li>
            <li><a href="unimedida.php" class="dropdown-item">Unidad de Medida</a></li>
            <li><a href="impinterno.php" class="dropdown-item">Impuesto Interno</a></li>
            </ul>
		</li><!-- Fin Menu4  -->
          <!-- Inicio Menu5 -->	
		<li class="nav-item dropdown"><!-- Menu2  -->
		<a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle">Ventas</a>
			<ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
              <li><a href="emicomprobantes.php" class="dropdown-item">Emision de Comprobantes</a></li>
    ...
    </div>Categoria:<?PHP echo $nomb_acc."<br>"; echo date('d\/m\/Y'); ?>
  </nav>
<?PHP   
  ...
  <nav class="navbar-expand-md navbar-light navbar" >
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse order-3" id="navbarCollapse">
		...
		<a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle">Ventas</a>
			<ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
              <li><a href="ventas.php" class="dropdown-item">Emision de Comprobantes</a></li>
              <li><a href="#" class="dropdown-item">Rectificados</a></li>
              <li><a href="#" class="dropdown-item">Cierre de Caja</a></li>        
			</ul>
		</li><!-- Fin Menu2  -->
		...
		<a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle">Stock</a>
			<ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                <li><a href="remito_provee.php" class="dropdown-item">Recepcion de Mercaderia</a></li>
                <li><a href="remito_interno.php" class="dropdown-item">Remitos Internos</a></li>
    			</ul>
		</li><!-- Fin Menu2  -->	
    </ul>
...
//    
echo "asdasdasdasdasdasdasdsa 2";           
